...
public class BackService extends Service {
    ...
    public static final String HOST = "192.168.4.1";// "192.168.1.34";//
    /**服务器端口号*/
...
//                                Intent intent=nullnews Intent(HEART_BEAT_ACTION);
//                                mLocalBroadcastManager.sendBroadcast(intent);
                            }else{
                                //其他消息回复
                                Intent intent=new Intent();
                                intent.putExtra("contant", message);
                                intent.setAction("com.example.administrator.androidfloorhot.socket");
//                                mLocalBroadcastManager.sendBroadcast(intent);
